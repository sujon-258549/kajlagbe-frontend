          ...
          <div className="lg:w-1/2 space-y-8 relative z-10 text-center lg:text-left">
            <div className="space-y-4">
              ...
              <p className="text-xl text-slate-400 leading-relaxed">
                Download the KajLagbe app to book services, track professionals
                in real-time, and get exclusive app-only discounts.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-6">
              ...
              <Button
                variant="outline"
                className="bg-white/5 border-white/10 text-white hover:bg-white hover:text-secondary h-16 px-8 rounded-2xl flex items-center gap-3"
              >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[...Array(6)].map((_, i) => (
                        <div
                          key={i}
                          className="aspect-square bg-slate-800 rounded-xl"
                        ></div>
                      ))}
                    </div>
                  </div>
