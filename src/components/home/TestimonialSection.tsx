...
const testimonials = [
  {
    ...
    name: "Pete Goldner",
    role: "Client",
    content: "It vinyl distillery trade raw. Asymmetrical lyft shaman vaporware street affogato. Mi marfa vibecession pug offal.",
  ...
  },
  {
    ...
    role: "Client",
    content: "Great response time, staff was on time and got the job done pretty quickly. House looked great when they finished.",
  ...
  },
  {
    ...
    name: "John Doe",
    role: "Home Owner",
    content: "The quality of work was exceptional. They exceeded my expectations in every way possible. Highly professional team.",
  ...
  return (
    <section className="py-12 md:py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <div className="bg-[#43934A] rounded-[2.5rem] md:rounded-[3.5rem] overflow-hidden flex flex-col lg:flex-row relative min-h-[600px] lg:h-[700px] shadow-2xl">
          
          {/* Glossy Spheres (Reference Image Matched) */}
          <div className="absolute top-[8%] left-[40%] w-24 h-24 rounded-full z-0 opacity-40 bg-radial-[at_30%_30%,_rgba(255,255,255,0.4)_0%,_rgba(255,255,255,0)_70%] border border-white/10 backdrop-blur-sm shadow-2xl animate-pulse"></div>
              ...
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full w-fit">
                <div className="bg-white p-1 rounded-full shadow-lg">
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
                    ...
                    <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.66l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z"/>
                  </svg>
                </div>
                <div className="flex gap-0.5">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className={`w-3 h-3 ${i < 5 ? "fill-[#FBBC05] text-[#FBBC05]" : "text-white/30"}`} />
                  ))}
                </div>
                  ...
                  <SwiperSlide key={testimonial.id}>
                    <div className="bg-[#F8FBF8] rounded-[2rem] p-8 md:p-10 space-y-6 shadow-xl h-full border border-white/50">
                      ...
                      <div className="flex items-center gap-4 pt-4">
                        ...
                        <div>
                          <div className="font-bold text-slate-900 text-[15px]">{testimonial.name}</div>
                          <div className="text-slate-400 text-xs font-bold uppercase tracking-wider">{testimonial.role}</div>
                        </div>
                      </div>
                    </div>
                  </SwiperSlide>
