...
const projects = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1558905612-1433f4868427?auto=format&fit=crop&q=80",
    color: "bg-secondary",
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1558002038-103792e07172?auto=format&fit=crop&q=80",
    color: "bg-[#9b6ef3]",
  },
  {
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
          ...
          <div className="flex gap-4">
            {["All", "Tech", "Home", "Creative"].map((tab, i) => (
              <button
                key={i}
                className={`px-6 py-2 font-bold transition-all ${i === 0 ? "bg-secondary text-white" : "text-slate-400 hover:text-secondary"}`}
              >
                {tab}
              </button>
            ))}
