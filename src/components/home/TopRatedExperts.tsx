...
const experts = [
  ...
  },
  {
    ...
    role: "Home Tutor",
    image:
      "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?auto=format&fit=crop&q=80",
    rating: 4.7,
    jobs: 56,
      ...
      <div className="main-container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-black">
            Our Highest Rated <span className="text-primary">Experts</span>
          </h2>
          <p className="text-lg text-slate-500">
            Hand-picked and background verified professionals who have
            consistently delivered 5-star services.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {experts.map((expert, index) => (
            <div
              key={index}
              className="group bg-white border border-slate-100 rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-500"
            >
              <div className="relative aspect-[4/5]">
                ...
                />
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full flex items-center gap-1 text-xs font-bold text-black">
