      ...
      <div className="main-container mx-auto px-4 relative">
        ...
        <AdminOnly>
          <button
            ...
            className="absolute top-0 right-8 w-10 h-10 flex items-center justify-center rounded-full bg-secondary/10 border border-secondary/20 text-secondary opacity-0 group-hover/section:opacity-100 transition-all z-40 hover:bg-secondary hover:text-white"
            title="Edit Section"
          >
