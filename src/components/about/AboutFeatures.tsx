...
export default function AboutFeatures() {
  return (
    <section className="py-16 lg:py-24 bg-[#f8fdf4]">
      <div className="main-container mx-auto px-4 text-center">
        <div className="max-w-2xl mx-auto mb-12">
          ...
          <Heading2 className="text-[#154d2e] mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="bg-white p-8 rounded-2xl border border-gray-200 hover:border-gray-300 transition-all group"
            >
              <div className="w-16 h-16 mx-auto bg-[#e6f4da] rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <feature.icon className="w-8 h-8 text-[#154d2e]" />
              </div>
              <Heading3 className="font-bold text-xl text-[#154d2e] mb-3">
                {feature.title}
              </Heading3>
