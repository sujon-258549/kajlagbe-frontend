        ...
        <div className="md:max-w-md w-full px-4 py-4">
          <form>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  type="text"
                  required
                  className="w-full text-secondary text-sm border-b border-slate-300 focus:border-secondary pl-2 pr-8 py-3 outline-none"
            ...
            <div className="mt-12">
              <button
                type="button"
                className="w-full  py-2.5 px-4 text-sm font-medium tracking-wide rounded-md text-white bg-secondary hover:bg-secondary/90 focus:outline-none cursor-pointer"
              >
                Sign in
              </button>
            </div>
