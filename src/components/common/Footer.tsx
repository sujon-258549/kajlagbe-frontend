        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="space-y-6 flex flex-col items-start text-left">
            ...
            <p className="text-[15px] leading-relaxed">
              We provide the best solution for your business. We have a team of
              experienced professionals who are ready to help you.
            </p>
            <div className="flex gap-4 pt-2">
              <Link
                href="#"
                className="h-8 w-8 rounded-full bg-secondary/80 hover:bg-primary flex items-center justify-center text-primary-foreground transition-all duration-300"
              >
          ...
          <div className="space-y-6">
            <h3 className="text-xl font-bold text-primary-foreground relative pl-4 after:content-[''] after:absolute after:left-0 after:top-1/2 after:-translate-y-1/2 after:h-4 after:w-1 after:bg-primary">
              Company
            </h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/about"
                  className="hover:text-primary transition-colors text-[15px] flex items-center gap-2"
                >
                  <div className="h-1.5 w-1.5 bg-primary rounded-full opacity-0 hover:opacity-100 transition-opacity"></div>
                  About Us
                </Link>
              </li>
              <li>
